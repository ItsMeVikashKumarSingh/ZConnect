    ...
    <div className="min-h-screen bg-background text-foreground relative transition-colors duration-300">
      ...
      <section id="chat-capabilities" className="max-w-7xl mx-auto px-6 py-20 border-t border-border/60 space-y-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-6xl mx-auto">
          ...
          <div className="premium-card bg-card p-8 space-y-6 flex flex-col justify-between">
            <div className="space-y-4">
              ...
              <p className="text-muted-foreground text-sm leading-relaxed">
                Embed a responsive floating chat widget directly on your site. Users can search categories, resolve issues using self-service FAQs, or easily handoff to a live human operator.
              </p>
          ...
          <div className="premium-card bg-card p-8 space-y-6 flex flex-col justify-between">
            <div className="space-y-4">
              ...
              <p className="text-muted-foreground text-sm leading-relaxed">
                Equip your support operators with a comprehensive, lightning-fast dashboard console. Track incoming chat sessions, filter active tickets, and respond instantly using canned templates.
              </p>
              <ul className="text-xs text-muted-foreground space-y-2 pt-1">
          ...
          {/* Card 3: Separated Support Simulator Sandbox */}
          <div className="premium-card bg-card p-8 border-primary-accent/30 bg-primary-accent/[0.02] space-y-6 flex flex-col justify-between relative overflow-hidden">
            <div className="absolute top-0 right-0 h-20 w-20 bg-primary-accent/5 rounded-full blur-xl pointer-events-none"></div>
            <div className="space-y-4">
              <div className="h-12 w-12 rounded-xl bg-primary-accent/10 text-primary-accent flex items-center justify-center">
                <Play className="h-5 w-5 fill-current" />
              </div>
              <h3 className="text-lg font-bold text-foreground">3. Live Support Sandbox</h3>
              <p className="text-muted-foreground text-sm leading-relaxed">
                Open our interactive simulator overlays. Send test tickets from the user-widget preview and watch them update live on the agent dashboard without leaving the landing page.
              </p>
              <ul className="text-xs text-muted-foreground space-y-2 pt-1">
                <li className="flex items-center gap-2"><CheckCircle className="h-3.5 w-3.5 text-green-500 shrink-0" /> Side-by-side real-time workspace</li>
                <li className="flex items-center gap-2"><CheckCircle className="h-3.5 w-3.5 text-green-500 shrink-0" /> Simulation of prechat forms & FAQs</li>
              </ul>
            </div>
            <button
              onClick={() => setShowSimulator(true)}
              className="bg-primary-accent hover:bg-primary-accent-hover text-primary-accent-foreground text-xs font-bold font-mono uppercase tracking-wider py-3 rounded-lg transition-all w-full flex items-center justify-center gap-2 cursor-pointer shadow-sm"
            >
              Launch Live Simulator
      ...
      {/* ----------------------------------------------------
          FULL-SCREEN INTERACTIVE SIMULATOR MODAL OVERLAY
          ---------------------------------------------------- */}
      <AnimatePresence>
        {showSimulator && (
          <motion.div
